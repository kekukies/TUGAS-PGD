...
$motto = "Lebih baik terlihat cupu, daripada menjadi cepu.";
...
body{
    font-family: Arial;
    background: linear-gradient(to right, #E6EEF2, #5F7A99);
}
.container{
    width: 900px;
    margin: auto;
...
<h2>Skills Nonton Stream Seharian</h2>
...
<script>
alert("Secantik gita gutawa, sebiru nakula nalendra, saya keisha, selamat datang di halaman saya!");
</script>
